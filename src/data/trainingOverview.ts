...
export const trainingCourses: TrainingCourse[] = [
  ...
  },
  {
    ...
    description: 'Celodenní workshop pro týmy, které chtějí s AI navrhovat a stavět weby, interní nástroje a prototypy, vyznat se v Claude Code, Codex, Cursor, Lovable, GitHubu, Vercelu i Supabase a vědět, kde má vibe coding skutečný přínos.',
    meta: ['celý den', 'do 15 osob', 'online / ve firmě', '29 000 Kč'],
    href: '/workshop-vibe-codingu-pro-firmy/',
    note: 'Od nápadu k funkčnímu prototypu bez zdlouhavého vývoje. Vhodné pro týmy, které chtějí rychleji ověřovat nápady a méně čekat na externí vývoj.',
  },
];
