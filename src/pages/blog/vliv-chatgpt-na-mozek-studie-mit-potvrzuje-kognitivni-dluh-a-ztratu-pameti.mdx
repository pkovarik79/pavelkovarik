...
title: "Vliv ChatGPT na mozek: Studie MIT potvrzuje kognitivní dluh a ztrátu paměti"
description: "Co když vás používání AI stojí víc, než si myslíte? Nová studie z prestižního MIT prokázala, že opakované používání ChatGPT mění způsob fungování mozku, a ne..."
date: "2025-06-24"
---
...
**Paměť a****míra****zapamatování:**Lidé používající ChatGPT si pamatovali jen třetinu vlastního textu, zatímco ti bez AI si pamatovali dvě třetiny. V**liv AI na paměť**je dramatický.

**A****ktivita mozku:**Vliv umělé inteligence snižuje komunikaci mezi oblastmi mozku zodpovědnými za hluboké myšlení a kreativitu

**P****řetrvávající efekt:**Kognitivní dluh znamená zhoršený výkon přetrvávající několik hodin poté, co AI vypneme
